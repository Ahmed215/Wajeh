...
const routes: Routes = [
  ...
  { path: "details/:id", component: DetailsComponent, canActivate: [AppRouteGuard] },
   { path: "UpdateDriver/:id", component: UpdateDriverComponent, canActivate: [AppRouteGuard] },
   { path: "CreateDriver", component: CreateDriverComponent, canActivate: [AppRouteGuard] },
   { path: "RegisterDriver/:id", component: RegisterDriverComponent, canActivate: [AppRouteGuard] },
];
@NgModule({
