...
import { CategoryDto, CreateCategoryDto, AdminUpdateClientDto, AdminClientServiceProxy, CompanyServiceProxy, CompanyDtoPagedResultDto } from '@shared/service-proxies/service-proxies';
