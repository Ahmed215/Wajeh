...
import {  CompanyDto, AdminCategoryServiceProxy, AdminCreateCategoryDto } from '@shared/service-proxies/service-proxies';
...
export class CreateCategoryComponent extends AppComponentBase implements OnInit {
  ...
  constructor(injector: Injector,
    private _formBuilder: FormBuilder, private _categoryService: AdminCategoryServiceProxy,private _router: Router) {
    super(injector);
  }
