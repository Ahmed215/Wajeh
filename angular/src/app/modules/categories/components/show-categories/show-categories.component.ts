import {  RoleServiceProxy, AdminCategoryDto, AdminCategoryServiceProxy, AdminSubcategoryDto, AdminSubategoryServiceProxy } from "./../../../../../shared/service-proxies/service-proxies";
...
export class ShowCategoriesComponent extends AppComponentBase implements OnInit {
  tabNum = 1;
  items: MenuItem[];
  selectedCars3: any[];
  personnelsCols: any[];
