...
import {  CategoryDto, AdminSubategoryServiceProxy, CreateCategoryDto, AdminUpdateSubcategoryDto, AdminCategoryServiceProxy, AdminCategoryDtoPagedResultDto } from '@shared/service-proxies/service-proxies';
...
export class UpdateSubcategoryComponent extends AppComponentBase implements OnInit {
  ...
  patchFirstFormGroup() {
    this.firstFormGroup.patchValue({
      ...
      categoryId: this.categories.find(c => c.value == this.subcategory.categoryId)
    });
  }
...
debugger;
    ...
    this.subcategory.image=(<string>this.userImageSrc).slice((<string>this.userImageSrc).indexOf(",")+1);
