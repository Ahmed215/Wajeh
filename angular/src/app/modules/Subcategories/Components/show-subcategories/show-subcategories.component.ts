import {  RoleServiceProxy, AdminCategoryDto, AdminCategoryServiceProxy, AdminSubcategoryDto, AdminSubategoryServiceProxy, AdminCategoryDtoPagedResultDto } from "./../../../../../shared/service-proxies/service-proxies";
...
export class ShowSubcategoriesComponent extends AppComponentBase implements OnInit {
  tabNum = 1;
  items: MenuItem[];
  selectedCars3: any[];
  personnelsCols: any[];
...
this.initCatss();
  ...
  loadEmployees() {
    ...
    this._subcategoryService
      .getAll(
        "",this.category == null  || this.category == undefined? undefined : this.category.value,
