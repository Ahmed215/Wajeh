...
import {  AdminSubategoryServiceProxy,AdminCategoryServiceProxy, AdminCreateSubcategoryDto, AdminCategoryDtoPagedResultDto } from '@shared/service-proxies/service-proxies';
...
export class CreateSubCategoryComponent extends AppComponentBase implements OnInit {
  ...
  constructor(injector: Injector,
    ...
    ,private _router: Router,private _categoryService: AdminCategoryServiceProxy) {
    super(injector);
  }
