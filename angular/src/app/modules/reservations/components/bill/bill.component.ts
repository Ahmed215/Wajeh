...
import {
  AdminRequestServiceProxy, AdminCreateRequestDto,GetOfferPriceDto,
  AdminDriverDtoPagedResultDto, UserServiceProxy, AdminDriverServiceProxy, OfferPriceServiceProxy
  ...
  initDrivers() {
    ...
    this.driversServices
      ...
      .subscribe((result: AdminDriverDtoPagedResultDto) => {
        ...
        this.offerPriceService.offerPriceByRequestId(model)
          .subscribe(res => {
