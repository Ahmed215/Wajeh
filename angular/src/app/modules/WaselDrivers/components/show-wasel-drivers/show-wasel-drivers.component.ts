import {  RoleServiceProxy, AdminCategoryDto, AdminCategoryServiceProxy,
   AdminSubcategoryDto, CompanyServiceProxy, CompanyDto, AdminVechileServiceProxy, 
   AdminVechileDto, AdminWaselDriverDto, AdminWaselDriverServiceProxy } from './../../../../../shared/service-proxies/service-proxies';
...
export class ShowWaselDriversComponent extends AppComponentBase implements OnInit {
  tabNum = 1;
  items: MenuItem[];
  selectedCars3: any[];
  personnelsCols: any[];
