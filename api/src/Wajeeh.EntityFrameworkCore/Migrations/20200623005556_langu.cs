...
{
    public partial class langu : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientAppAbouts", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ClientAppTermsAndPolicies",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientAppTermsAndPolicies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhoneCodeConfirms", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LangLat = table.Column<string>(nullable: true),
                    UserId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientAdresses_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clients_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationLogs_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationTokens_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyClients_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    VehicleSequenceNumber = table.Column<string>(nullable: true),
                    DriverIdentityNumber = table.Column<string>(nullable: true),
                    IsDriverAvilable = table.Column<bool>(nullable: false),
                    Email = table.Column<string>(nullable: true),
                    FullName = table.Column<string>(nullable: true),
                    VehicleType = table.Column<long>(nullable: false),
                    ProfilePicture = table.Column<string>(nullable: true),
                    IdentityPicture = table.Column<string>(nullable: true),
                    FrontVehiclePicture = table.Column<string>(nullable: true),
                    BackVehiclePicture = table.Column<string>(nullable: true),
                    LisencePicture = table.Column<string>(nullable: true),
                    VehicleLisencePicture = table.Column<string>(nullable: true),
                    UserId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    IsClientRated = table.Column<bool>(nullable: true),
                    ClientRate = table.Column<int>(nullable: true),
                    ...
                    StratingPointAdress = table.Column<string>(nullable: true),
                    StratingPointTitle = table.Column<string>(nullable: true),
                    EndingPointAdress = table.Column<string>(nullable: true),
                    EndingPointTitle = table.Column<string>(nullable: true),
                    SubcategoryId = table.Column<long>(nullable: false),
                    UserRequsetId = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_AbpUsers_UserRequsetId",
                        column: x => x.UserRequsetId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDriverRead = table.Column<bool>(nullable: true),
                    IsRated = table.Column<bool>(nullable: true),
                    Rate = table.Column<int>(nullable: true),
                    ...
                    AwayFrom = table.Column<string>(nullable: true),
                    DeliveryThroughDays = table.Column<int>(nullable: false),
                    DeliveryThroughHours = table.Column<int>(nullable: false),
                    DeliveryThroughMinutes = table.Column<int>(nullable: false),
                    DeliveryThroughSeconds = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OfferPrices_Requests_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_UserRequsetId",
                table: "Requests",
                column: "UserRequsetId");
